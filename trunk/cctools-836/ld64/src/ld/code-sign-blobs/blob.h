...
public:
	...
	static BlobCore *readBlob(FILE *file)	{ return readBlob(file, 0, 0, 0); }
	static BlobCore *readBlob(int fd)			{ return readBlob(fd, 0, 0, 0); }
	
protected:
	static BlobCore *readBlob(FILE *file, uint32_t magic, size_t minSize, size_t maxSize); // streaming
...
public:
	...
	static BlobType *readBlob(FILE *file)
