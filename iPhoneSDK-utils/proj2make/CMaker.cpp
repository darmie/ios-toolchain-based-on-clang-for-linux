...
bool CMaker::build_make( char *id,char *compiler,char *cflags,char *ldflags, char *bin_dir)
{
    ...
    string info_plist = find_file_in_dir(".", "Info.plist", "", ".plist");
    //get *.pch filename.
    string local_pch = find_file_in_dir(".", "Prefix.pch", "", ".pch");

    //guess Resources need to be put into .app dir.
    string res_dir = find_dir_in_dir(".", "Resources", "", "");
    string res2_dir = find_dir_in_dir(".", "images", "", "");
   
    string lproj_dir = find_dir_in_dir(".", ".lproj", "", "");
